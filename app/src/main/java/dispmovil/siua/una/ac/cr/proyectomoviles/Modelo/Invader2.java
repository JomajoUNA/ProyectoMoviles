 ...
 */
public class Invader2 extends View {
    ...
    public Invader2(Context context,int ancho,int largo,boolean estado) {
    ...
    {
        setFocusable(true);
        gifInputStream = context.getResources().openRawResource(R.drawable.invader1);
