 ...
 */
public class Invader1 extends View{
    ...
    public Invader1(Context context,int ancho,int largo,boolean estado) {
    ...
    {
        setFocusable(true);
        gifInputStream = context.getResources().openRawResource(R.drawable.invader2);
